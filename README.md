...
```javascript
drange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-drange@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-drange/tags). For example,

```javascript
drange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-drange@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var drange = require( 'path/to/vendor/umd/stats-base-drange/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-drange/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-drange/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/stats-base-drange/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-drange/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-drange/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-drange/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-drange/blob/esm/README.md
